          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <span className="text-xl font-bold text-gray-900">DABS</span>
              </div>
              <p className="text-sm leading-relaxed text-gray-600">
                Doctor Appointment Booking System - Making healthcare accessible
                and convenient for everyone. Book appointments with trusted healthcare
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                {[
                  ...
                  { to: "/patient/payment", label: "Payment History" },
              ...
              <ul className="mt-4 space-y-3">
                <li>
                  <div className="flex items-start space-x-3 text-sm text-gray-600">
                    ...
                    <span>123 Medical Center Drive<br/>Ho Chi Minh City, Vietnam</span>
                  </div>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span>phananhthai.dao04@gmail.com</span>
                  </a>
                </li>
                <li>
                  <a
        ...
        <div className="border-t border-gray-100 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} DABS. All rights reserved.
            </p>
