...
const HeroBanner = () => {
    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 w-full h-full overflow-x-clip pointer-events-none select-none">
                ...
                <div className="absolute inset-0">
                    <div className="absolute left-1/2 top-1/4 w-72 h-72 -translate-x-1/2 bg-blue-500/30 rounded-full blur-3xl animate-pulse"></div>
                    <div className="absolute left-1/2 bottom-1/4 w-96 h-96 -translate-x-1/2 bg-indigo-500/20 rounded-full blur-3xl animate-pulse delay-700"></div>
                </div>
            </div>
