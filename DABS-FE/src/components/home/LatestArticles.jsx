                    ...
                    {articles.map((blog, index) => (
                        ...
                        >
                            <Link to={`/articles/${blog.slug}`}>
                                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-500 border border-gray-100 dark:border-gray-700 cursor-pointer">
                      ...
                      <span className="px-3 py-1 bg-primary-600 text-white text-sm font-medium rounded-full">
                        {blog.category}
                                    ...
                                    <div className="p-6">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{blog.desc}</p>
